...
const Footer = () => {
  return (
    <div className="bg-black opacity-60 w-full flex flex-col items-center py-4 px-3 gap-y-4">
        <span className="text-base text-white text-center">Let's stay in touch! Sign up to our newsletter and get the best deals!</span>
        <img src="./logo.jpeg" alt="Company Logo" className="w-[100px] h-[100px]"/>
        <input
            type="text"
